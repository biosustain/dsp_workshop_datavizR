...
<div class="question">
  <strong>❓ Question:</strong> Do you remember what is the %>% doing in the code?
</div>
...
<div class="tip">
<strong>💡 Tip:</strong> Try to run line by line in the above code.
</div>
...
<div class="remember">
  <strong>📌 Remember:</strong> It is always a good idea to check the data after removing contaminants.
</div>
