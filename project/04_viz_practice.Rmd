...
<div class="question">
  <strong>❓ Question:</strong> Do you remember what the `%>%` (pipe) is doing in the code?
</div>
...
<div class="tip">
<strong>💡 Tip:</strong> Try to run the code above line by line.
</div>
...
<div class="remember">
  <strong>📌 Remember:</strong> It is always a good idea to check the data often while processing it.
</div>
...
<div class="question">
  <strong>❓ Question:</strong> Can you think about a different way of inspecting the data?</div>
...
<div class="question">
  <strong>❓ Question:</strong> How does the plot look like if you remove `geom_` layers one by one?
</div>
